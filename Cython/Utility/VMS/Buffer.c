...
static size_t __Pyx_BufFmt_TypeCharToNativeSize(char ch, int is_complex) {
  switch (ch) {
    ...
    case 'l': case 'L': return sizeof(int);
...
typedef struct { char c; int x; } __Pyx_st_long;
...
static size_t __Pyx_BufFmt_TypeCharToAlignment(char ch, CYTHON_UNUSED int is_complex) {
  switch (ch) {
    ...
    case 'l': case 'L': return sizeof(__Pyx_st_long) - sizeof(int);
#ifdef HAVE_LONG_LONG
...
typedef struct { int x; char c; } __Pyx_pad_long;
...
static size_t __Pyx_BufFmt_TypeCharToPadding(char ch, CYTHON_UNUSED int is_complex) {
  switch (ch) {
    ...
    case 'l': case 'L': return sizeof(__Pyx_pad_long) - sizeof(int);
#ifdef HAVE_LONG_LONG
